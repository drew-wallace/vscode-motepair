...
(function () {
	...
	EventHandler = (function () {
		...
		EventHandler.prototype.onopen = function (data) {
			...
			this.workspace.openTextDocument(path).then((function (_this) {
				return function(TextDocument){
					...
					_this.showTextDocument(TextDocument, vscode.ViewColumn.One, true); //<-- Shouldn't gain focus, but there's a bug: https://github.com/Microsoft/vscode/issues/11247
				};
			})(this));
		...
		EventHandler.prototype.oncursor = function (data) {
			...
			if(data.cursor.character === editor.document.lineAt(data.cursor.line).range.end.character) {
