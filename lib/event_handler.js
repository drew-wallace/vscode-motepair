...
(function () {
	...
	EventHandler = (function () {
		...
		EventHandler.prototype.oninsert = function (data) {
			...
			if (!editor.viewColumn()) return; // returns when editor is destroyed.
			var editor, ref1;
			editor = this.window.activeTextEditor;
			// Make sure this works both ways
			...
			var start = new vscode.Position(data.range.start.line, data.range.start.character);
			var end = new vscode.Position(data.range.end.line, data.range.end.character);
		...
		EventHandler.prototype.listen = function () {
			...
			this.subscriptions.push(this.workspace.onDidChangeTextDocument((function (_this) {
