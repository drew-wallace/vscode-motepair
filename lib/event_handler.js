...
(function () {
	...
	EventHandler = (function () {
		...
		EventHandler.prototype.oncursor = function (data) {
			...
			var editor, ref1;
			editor = this.window.activeTextEditor();
			if (!((editor && editor.document.fileName) && data.file === this.workspace.asRelativePath(editor.document.fileName))) {
				return;
			}
		...
		EventHandler.prototype.listen = function () {
			...
			this.subscriptions.push(this.window.onDidChangeTextEditorSelection((function (_this) {
				return function (selections, TextEditor) {
					...
					data = {
						...
						type: 'cursor',
						data: {
							file: _this.workspace.asRelativePath(TextEditor.document.fileName),
			...
			this.subscriptions.push(this.workspace.onDidSaveTextDocument((function (_this) {
				return function (TextDocument) {
					...
					return _this.sendFileEvents('save', _this.workspace.asRelativePath(TextDocument.fileName));
				};
			})(this)));
			this.subscriptions.push(this.workspace.onDidCloseTextDocument((function (_this) {
				return function (TextDocument) {
					...
					return _this.sendFileEvents('close', _this.workspace.asRelativePath(TextDocument.fileName));
				};
			})(this)));
			// If this is messed up, try 'onDidOpenTextDocument'
			return this.subscriptions.push(this.window.onDidChangeActiveTextEditor((function (_this) {
				return function (TextEditor) {
					...
					return _this.sendFileEvents('open', _this.workspace.asRelativePath(TextEditor.document.fileName));
				};
			})(this)));
		};
