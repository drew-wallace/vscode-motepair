...
(function () {
	...
	module.exports = {
		...
		setDefaultValues: function () {
			this.address = vscode.workspace.getConfiguration('motepair').get('serverAddress');
			this.portNumber = vscode.workspace.getConfiguration('motepair').get('serverPort');
			return this.secureConnection = vscode.workspace.getConfiguration('motepair').get('secureConnection');
		},
			...
			this.ws.on("open", (function (_this) {
				return function () {
					...
					_this.ws.send(JSON.stringify({
						...
						motepairVersion: require('../package.json').version
					}));
