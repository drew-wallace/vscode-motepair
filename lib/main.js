...
(function() {
  ...
  var VSCodeShare, EventHandler, NewSessionView, SessionView, WebSocket;
  ...
  module.exports = {
    ...
    setDefaultValues: function() {
      ...
      this.address = this.workspace.getConfiguration('motepair.serverAddress');
	    this.portNumber = this.workspace.getConfiguration('motepair.serverPort');
      return this.secureConnection = this.workspace.getConfiguration('motepair.secureConnection');
    },
    ...
    startSession: function() {
      ...
      vscode.window.showInformationMessage("This is your Motepair Session ID: " + sessionId)
